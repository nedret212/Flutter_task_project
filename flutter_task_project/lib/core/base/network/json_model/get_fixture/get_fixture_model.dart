class GetFixtureModel {
  ...
  GetFixtureModel.fromJson(Map<String, dynamic> json) {
    get = json['get'];
    ...
    if (json['response'] != null) {
      ...
      json['response'].forEach((v) {
        response.add(new ResponseData.fromJson(v));
      });
    }
  }
...
class ResponseData {
  ...
  ResponseData({this.fixture, this.league, this.teams, this.goals});
